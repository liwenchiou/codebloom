...
const QASection = () => {
    // 模擬資料 (Data Mock)
    const qaList = [
        { id: 1, status: '待解決', time: '5 小時前', count: 2, title: 'useEffect 造成無限 re-render，依賴陣列該怎麼設？' },
        { id: 2, status: '待解決', time: '1 週前', count: 2, title: '請問這種 3D 翻轉卡片的效果， 純 CSS 做得到嗎？' },
        { id: 3, status: '已解決', time: '2 天前', count: 8, title: '遇到 CORS 跨域錯誤，後端說他已經開了，為什麼前端還是報錯？' },
        { id: 4, status: '已解決', time: '2 天前', count: 6, title: 'async/await 與 forEach 裡面無效，執行順序該怎麼解？' },
        { id: 5, status: '已解決', time: '5 天前', count: 1, title: 'iOS Safari 的 100vh 導致下方被擋，網址列怎麼辦？' },
        { id: 6, status: '熱議中', time: '1 週前', count: 15, title: 'npm run build 打包後圖片全部 404，本機開發是正常的' },
    ];

    return (
        <section className="qa-section position-relative overflow-hidden bg-neutral-700 text-white">
            <div className="position-absolute top-0 start-0 w-100 h-100 " style={{
                backgroundImage: `url(${qaBg})`, backgroundSize: 'cover', backgroundPosition: 'center', opacity: 1,
